...
export default function PowerPointToPdf() {
  ...
  const wordToPdf = async () => {
    ...
    try {
      ...
      downloadFile({
        fileName: `converted-powerpoint-to-pdf-${getDateToFileConverted()}.pdf`,
        blobFile: blobFile,
      });
  ...
  return (
    <div className={pageMainSection}>
      {!loading && finishedTask && (
        <SuccessFinishedTask
          title={ptJson.convert_to_pdf_success}
      ...
      {loading && (
        <MainFileLoading text={ptJson.convert_to_pdf_progress_text} />
      )}
      ...
      {!loading && !finishedTask && (
        <div>
          <PageIntroTitle
            ...
            subtitle={ptJson.powerpoint_pdf_description}
          />
